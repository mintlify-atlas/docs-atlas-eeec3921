---
title: "Quikko Rate Limiting: Endpoints, Defaults, and Configuration"
sidebarTitle: "Rate Limits"
description: "Quikko enforces per-IP and per-user Redis rate limits on four endpoints. Learn the env var names, default values, 429 response schema, and tuning guidance."
---
