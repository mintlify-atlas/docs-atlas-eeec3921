---
title: "QR Code Generation for Quikko Short URLs on Demand"
sidebarTitle: "QR Codes"
description: "Every Quikko short URL ships with an on-demand QR code as a PNG data URI. No separate API call needed — the QR is included in the creation response."
---
