---
title: "URLs API: Create, List, and Manage Short Links"
sidebarTitle: "URLs"
description: "REST endpoints to create short URLs with optional custom aliases, list URLs with filtering and pagination, toggle active state, and delete links."
---
